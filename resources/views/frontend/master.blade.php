...
<!-- Mirrored from themesflat.co/html/ecomus/home-08.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Aug 2024 01:22:24 GMT -->
...
<body class="preload-wrapper">
                    ...
                    <div class="row-demo">
                        <div class="demo-item">
                            <a href="index.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-01.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-01.jpg') }}" alt="home-01">
                        ...
                        <div class="demo-item">
                            <a href="home-multi-brand.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-multi-brand.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-multi-brand.jpg') }}" alt="home-multi-brand">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                        ...
                        <div class="demo-item">
                            <a href="home-02.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-02.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-02.jpg') }}" alt="home-02">
                                    <div class="demo-label">
                                        <span class="demo-hot">Hot</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-03.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-03.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-03.jpg') }}" alt="home-03">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-04.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-04.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-04.jpg') }}" alt="home-04">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-05.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-05.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-05.jpg') }}" alt="home-05">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-06.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-06.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-06.jpg') }}" alt="home-06">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-07.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-07.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-07.jpg') }}" alt="home-07">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-08.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-08.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-08.jpg') }}" alt="home-08">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-skincare.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-skincare.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-skincare.jpg') }}" alt="home-skincare">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-headphone.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-headphone.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-headphone.jpg') }}" alt="home-headphone">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-giftcard.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-giftcard.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-giftcard.jpg') }}" alt="home-gift-card">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-furniture.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-furniture.jpg') }}" alt="home-furniture">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture-02.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-furniture2.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-furniture2.jpg') }}" alt="home-furniture-2">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-skateboard.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-skateboard.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-skateboard.jpg') }}" alt="home-skateboard">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-stroller.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-stroller.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-stroller.jpg') }}" alt="home-stroller">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-decor.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-decor.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-decor.jpg') }}" alt="home-decor">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-electronic.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-electronic.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-electronic.jpg') }}" alt="home-electronic">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-setup-gear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-setup-gear.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-setup-gear.jpg') }}" alt="home-setup-gear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-dog-accessories.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-dog-accessories.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-dog-accessories.jpg') }}" alt="home-dog-accessories">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-kitchen-wear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-kitchen.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-kitchen.jpg') }}" alt="home-kitchen-wear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-phonecase.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-phonecase.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-phonecase.jpg') }}" alt="home-phonecase">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-paddle-boards.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home_paddle_board.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home_paddle_board.jpg') }}" alt="home-paddle_board">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-glasses.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-glasses.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-glasses.jpg') }}" alt="home-glasses">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-pod-store.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-pod-store.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-pod-store.jpg') }}" alt="home-pod-store">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-activewear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-activewear.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-activewear.jpg') }}" alt="home-activewear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-handbag.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-handbag.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-handbag.jpg') }}" alt="home-handbag">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-tee.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-tee.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-tee.jpg') }}" alt="home-tee">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sock.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-socks.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-socks.jpg') }}" alt="home-sock">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-jewerly.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-jewelry.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-jewelry.jpg') }}" alt="home-jewelry">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sneaker.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('frontend/images/demo/home-sneaker.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-sneaker.jpg') }}" alt="home-sneaker">
                                </div>
                        ...
                        <div id="dropdown-menu-four" class="collapse">
                            <ul class="sub-nav-menu" id="sub-menu-navigation">
                                ...
                                <li><a href="brands.html" class="sub-nav-link line-clamp">Brands<div class="demo-label">
                                            <span class="demo-new">New</span></div></a></li>
    ...
    @include('frontend.product_view.shopping_cart')
    ...
    <!-- modal quick_add -->
    @include('frontend.product_view.product_quick_add')

    <!-- /modal quick_add -->

    <!-- modal quick_view -->
    @include('frontend.product_view.product_quick_view')

    <!-- /modal quick_view -->

    <!-- modal find_size -->
    <div class="modal modalLeft fade modalDemo tf-product-modal" id="find_size">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="header">
