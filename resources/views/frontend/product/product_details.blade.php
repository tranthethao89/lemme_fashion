...
<body class="preload-wrapper">
    <div id="wrapper">
            ...
            <div class="container">
                <div class="tf-breadcrumb-wrap d-flex justify-content-between flex-wrap align-items-center">
                    <div class="tf-breadcrumb-list">
                        ...
                        <i class="icon icon-arrow-right"></i>
                        <span class="text">{{ $products->product_name }}</span>
                    </div>
        ...
        <!-- /breadcrumb -->
        <!-- default -->
       @include('frontend.allproduct.product_show')

        <!-- /default -->
        <!-- tabs -->
        <!-- /tabs -->
        <!-- product -->
       @include('frontend.allproduct.product_related')
        <!-- /product -->
        <!-- recent -->
       @include('frontend.allproduct.product_recents')
        <!-- /recent -->
        <!-- footer -->
...
<!-- Mirrored from themesflat.co/html/ecomus/product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Aug 2024 01:23:26 GMT -->
</html>
