...
<body class="preload-wrapper">
                                        ...
                                        <tr class="tf-cart-item file-delete">
                                            <td class="tf-cart-item_product">
                                                <a href="product-detail.html" class="img-box">
                                                    {{-- <img src="{{ asset($value['image']) }}" alt="img-product"> --}}
                                                </a>
                                                <div class="cart-info">
                                                    {{-- <a href="product-detail.html" class="cart-title link">{{ $cart['product']['product_name'] }}</a> --}}
                    ...
                    <div class="row-demo">
                        ...
                        <div class="demo-item">
                            <a href="home-multi-brand.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-multi-brand.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-multi-brand.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-skincare.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-skincare.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-headphone.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-headphone.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-headphone.jpg') }}"
                                        alt="home-headphone">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-giftcard.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-giftcard.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-giftcard.jpg') }}"
                                        alt="home-gift-card">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-furniture.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-furniture.jpg') }}"
                                        alt="home-furniture">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture-02.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-furniture2.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-furniture2.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-skateboard.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-skateboard.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-skateboard.jpg') }}"
                                        alt="home-skateboard">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-stroller.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-stroller.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-electronic.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-electronic.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-electronic.jpg') }}"
                                        alt="home-electronic">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-setup-gear.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-setup-gear.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-setup-gear.jpg') }}"
                                        alt="home-setup-gear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-dog-accessories.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-dog-accessories.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-dog-accessories.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-kitchen-wear.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-kitchen.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-kitchen.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-phonecase.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-phonecase.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-phonecase.jpg') }}"
                                        alt="home-phonecase">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-paddle-boards.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home_paddle_board.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home_paddle_board.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-glasses.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-glasses.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-pod-store.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-pod-store.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-pod-store.jpg') }}"
                                        alt="home-pod-store">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-activewear.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-activewear.jpg') }}"
                                        src="{{ asset('frontend/images/demo/home-activewear.jpg') }}"
                                        alt="home-activewear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-handbag.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-handbag.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-jewerly.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-jewelry.jpg') }}"
                        ...
                        <div class="demo-item">
                            <a href="home-sneaker.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('frontend/images/demo/home-sneaker.jpg') }}"
                                        ...
                                        <ul class="sub-nav-menu sub-menu-level-2">
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src="{{ asset('frontend/images/shop/cate/cate1.jpg') }}"
                                                            alt="">
                                                    </div>
                                                    <span>Accessories</span>
                                                </a>
                                            ...
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src="{{ asset('frontend/images/shop/cate/cate8.jpg') }}"
                                                            alt="">
                                                    </div>
                                                    <span>Shoes</span>
                                                </a>
                                    ...
                                    <div id="cate-shop-two" class="collapse">
                                        <ul class="sub-nav-menu sub-menu-level-2">
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src="{{ asset('frontend/images/shop/cate/cate4.png') }}"
                                                            alt="">
                                                    </div>
                                                    <span>Handbag</span>
                                                </a>
                                            ...
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src="{{ asset('frontend/images/shop/cate/cate7.jpg') }}"
                                                            alt="">
                                                    </div>
                                                    <span>Tee</span>
                                                </a>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="tf-minicart-recommendations-item">
                                                    <div class="tf-minicart-recommendations-item-image">
                                                        <a href="product-detail.html">
                                                            <img src="{{ asset('frontend/images/products/white-3.jpg') }}"
                                                                alt="">
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tf-minicart-recommendations-item">
                                                    <div class="tf-minicart-recommendations-item-image">
                                                        <a href="product-detail.html">
                                                            <img src="{{ asset('frontend/images/products/white-2.jpg') }}"
                                                                alt="">
                                                        </a>
                                                    </div>
                                                    <div class="tf-minicart-recommendations-item-infos flex-grow-1">
                                ...
                                <div class="tf-compare-offcanvas">
                                    <div class="tf-compare-item">
                                        <div class="position-relative">
                                            ...
                                            <a href="product-detail.html">
                                                <img class="radius-3"
                                                    src="{{ asset('frontend/images/products/orange-1.jpg') }}" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="tf-compare-item">
                                        <div class="position-relative">
                                            ...
                                            <a href="product-detail.html">
                                                <img class="radius-3"
                                                    src="{{ asset('frontend/images/products/pink-1.jpg') }}" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- modal quick_add -->
    <div class="modal modalLeft fade modalDemo" id="quick_add">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="header">
                    <span class="icon-close icon-close-popup" data-bs-dismiss="modal"></span>
    ...
    <!-- modal quick_view -->
    <div class="modal modalLeft fade modalDemo" id="quick_view">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="header">
                    <span class="icon-close icon-close-popup" data-bs-dismiss="modal"></span>
                    ...
                    <div class="tf-page-size-chart-content">
                        ...
                        <div>
                            <img class="sizechart lazyload"
                                data-src="{{ asset('frontend/images/shop/products/size_chart2.jpg') }}"
