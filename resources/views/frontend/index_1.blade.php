                            ...
                            <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                            ...
                                            <div class="text-center view-all-demo">
                                                <a href="#modalDemo" data-bs-toggle="modal"
                                                    class="tf-btn btn-xl btn-fill radius-3 animate-hover-btn fw-6"><span>View
                                                        all demos (31+)</span><i class="icon icon-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="menu-item position-relative">
                                    ...
                                    <div class="sub-menu submenu-default">
                                        <ul class="menu-list">
                                            <li><a href="about-us.html" class="menu-link-text link text_black-2">About
                                                    us</a></li>
                                            <li>
                                                <a href="brands.html"
                                            ...
                                            <li><a href="brands-v2.html" class="menu-link-text link text_black-2">Brand
                                                    V2</a></li>
                                            ...
                                            <li><a href="faq-1.html" class="menu-link-text link text_black-2">FAQ 01</a>
                                            </li>
                                            <li><a href="faq-2.html" class="menu-link-text link text_black-2">FAQ 02</a>
                                            </li>
                                            <li><a href="our-store.html" class="menu-link-text link text_black-2">Our
                                                    store</a></li>
                                            ...
                                            <li><a href="timeline.html"
                                                    ...
                                                    <div class="demo-label"><span class="demo-new">New</span></div> </a>
                                            </li>
                                            ...
                                            <li><a href="my-account.html"
                                                    class="menu-link-text link text_black-2 position-relative">My
                                                    Account</a></li>
                                        </ul>
                                    </div>
                                </li>
            ...
            <div class="container">
                <div class="masonry-layout-v2">
                    <div class="item-1 collection-item-v5 hover-img wow fadeInUp" data-wow-delay="0s">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/collection-59.jpg"
                                    src="images/collections/collection-59.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                    ...
                    <div class="item-2 collection-item-v5 hover-img wow fadeInUp" data-wow-delay="0s">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/collection-60.jpg"
                                    src="images/collections/collection-60.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                    ...
                    <div class="item-3 collection-item-v5 hover-img wow fadeInUp" data-wow-delay="0s">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/collection-61.jpg"
                                    src="images/collections/collection-61.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                    ...
                    <div class="item-4 collection-item-v5 hover-img wow fadeInUp" data-wow-delay="0s">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/collection-62.jpg"
                                    src="images/collections/collection-62.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                    ...
                    <div class="item-5 collection-item-v5 hover-img wow fadeInUp" data-wow-delay="0s">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/collection-63.jpg"
                                    src="images/collections/collection-63.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                ...
                <div class="flat-lookbook-v3 d-flex">
                    ...
                    <div class="col-right w-50">
                        <div class="wrap-lookbook lookbook-sw">
                            <div class="image">
                                <img class="lazyload" data-src="images/shop/file/lookbook-6.jpg"
                                    src="images/shop/file/lookbook-6.jpg" alt="collection-img">
                            </div>
                                            ...
                                            <div class="tf-currencies">
                                                <select
                                                    ...
                                                    <option data-thumbnail="images/country/de.svg">EUR <span>€ |
                                                            Germany</span></option>
                                                    <option selected data-thumbnail="images/country/us.svg">USD <span>$
