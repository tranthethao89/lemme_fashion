                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="{{ asset('backend/assets/images/logo-sm.svg') }}" alt="" height="28"> <span class="logo-txt">LEMME</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0">Bạn đã quên mật khẩu</h5>
                                            <p class="text-muted mt-2">Hãy nhập email để lấy lại mật khẩu.</p>
                                        </div>
                                        @if($errors->any())
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Design  <i class="mdi mdi-heart text-danger"></i> by LEMME</p>
                                    </div>
                                </div>
                            </div>
                        </div>
