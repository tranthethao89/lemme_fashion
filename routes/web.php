...
Route::get('/admin/login123', [AdminController::class, 'AdminLogin'])->name('admin.login');
...
Route::middleware('admin')->group(function () {
    ...
    Route::controller(SliderController::class)->group(function(){
        ...
        Route::get('/create', 'AddSlider')->name('slider.create');
        Route::post('/store/slider' , 'StoreSlider')->name('store.slider');
        Route::get('/delete/slider/{id}', 'SliderDelete')->name('slider.delete');
...
Route::controller(CartController::class)->group(function(){
    ...
    // Route::get('/add-to-cart/{id}', 'addToCart')->name('add-to-cart');
    // // --------------------------------------- ////////////
    Route::post('/add-cart', 'add')->name('cart.add');
